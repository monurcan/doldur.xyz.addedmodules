...
<nav class="top-bar sc-nav" data-topbar role="navigation">
  ...
  <section class="top-bar-section">
    <ul class="left">
		...
		<ul class="right">
			<div style="text-align:center; display:inline-block; color: white; background-color:#9b59b6;margin-right:10px;margin-top:5px;padding:3px 10px;">
...
<?php print_page(); ?>
	...
	?>
		...
		<div id="about-modal" class="reveal-modal tiny" data-reveal aria-labelledby="About" aria-hidden="true" role="dialog">
			...
			If you encounter any problems: monurcan55@gmail.com<br/>
		</div>
